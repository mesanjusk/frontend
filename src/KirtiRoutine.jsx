...
const KIRTI_TASKS = [
  { id:1,  section:'🌅 ब्रह्म मुहूर्त — Spiritual', time:'4:30 AM', task:'उठें — पुष्य नक्षत्र की शक्ति इस समय सबसे अधिक', tags:['🕉️'], pinned:true,  skippable:false },
  { id:2,  section:'🌅 ब्रह्म मुहूर्त — Spiritual', time:'4:35 AM', task:'तांबे के लोटे से पानी — 1 गिलास (रात भर रखा)', tags:['🏥'], pinned:false, skippable:false },
  ...
  { id:4,  section:'🌅 ब्रह्म मुहूर्त — Spiritual', time:'4:45 AM', task:'Sudarshan Kriya — Art of Living (NEVER MISS)', tags:['🕉️','🏥'], pinned:true,  skippable:false },
  { id:5,  section:'🌅 ब्रह्म मुहूर्त — Spiritual', time:'5:30 AM', task:'Meditation — 20 मिनट पूर्ण मौन', tags:['🕉️','🧠'], pinned:false, skippable:true  },
  { id:6,  section:'🌅 ब्रह्म मुहूर्त — Spiritual', time:'5:50 AM', task:"Mantra Jap — माला के साथ 'ॐ गुरवे नमः'", tags:['🕉️'], pinned:false, skippable:true  },
  { id:7,  section:'🌿 बगीचा — Healing Time', time:'6:10 AM', task:'बगीचे में जाएं — पौधों को पानी दें (सबसे बड़ी Therapy)', tags:['🌿','🏥'], pinned:true,  skippable:false },
  { id:8,  section:'🌿 बगीचा — Healing Time', time:'6:20 AM', task:'तुलसी को पानी — Healing herbs की देखभाल', tags:['🌿','🕉️'], pinned:false, skippable:true  },
  { id:9,  section:'🌿 बगीचा — Healing Time', time:'6:30 AM', task:'बगीचे में Meditation corner पर बैठें — 10 मिनट', tags:['🌿','🕉️'], pinned:false, skippable:true  },
  { id:10, section:'🌿 बगीचा — Healing Time', time:'6:40 AM', task:'नाश्ता — सात्विक, घर का बना (Court से पहले)', tags:['🏥'], pinned:false, skippable:false },
  { id:11, section:'🌿 बगीचा — Healing Time', time:'6:50 AM', task:'BP Check + पानी एक गिलास और', tags:['🏥'], pinned:false, skippable:false },
  { id:12, section:'⚖️ Court — Advocate Work', time:'7:15 AM', task:"Court की तैयारी — 3 Deep Breaths 'मैं निमित्त हूं'", tags:['⚖️','🧠'], pinned:false, skippable:true  },
  { id:13, section:'⚖️ Court — Advocate Work', time:'8:00 AM', task:'Court / Legal Work — पूरे ध्यान से', tags:['⚖️'], pinned:true,  skippable:false },
  { id:14, section:'⚖️ Court — Advocate Work', time:'8:00 AM', task:'आज के Important Cases की list देखें', tags:['⚖️'], pinned:false, skippable:true  },
  { id:15, section:'⚖️ Court — Advocate Work', time:'10:30 AM', task:'Break — पानी + 5 मिनट आंखें बंद', tags:['🏥'], pinned:false, skippable:true  },
  { id:16, section:'⚖️ Court — Advocate Work', time:'1:00 PM', task:'Lunch — शांति से, Gratitude के साथ, Phone बंद', tags:['🏥','🕉️'], pinned:false, skippable:false },
  { id:17, section:'⚖️ Court — Advocate Work', time:'1:30 PM', task:'10 मिनट Rest — Micro Meditation', tags:['🏥'], pinned:false, skippable:true  },
  { id:18, section:'🌍 AOL + JCI + Social Service', time:'4:00 PM', task:'AOL Teaching Preparation — Workshop content', tags:['🌍','🕉️'], pinned:false, skippable:true  },
  { id:19, section:'🌍 AOL + JCI + Social Service', time:'4:30 PM', task:'JCI Work — Community project / Meeting', tags:['🌍'], pinned:false, skippable:true  },
  { id:20, section:'🌍 AOL + JCI + Social Service', time:'5:00 PM', task:'Workshop planning — Gondia / Raipur community', tags:['🌍','🕉️'], pinned:false, skippable:true  },
  { id:21, section:'🌍 AOL + JCI + Social Service', time:'5:30 PM', task:'Free Legal Aid — कोई जरूरतमंद है? Help करें', tags:['⚖️','🌍'], pinned:false, skippable:true  },
  { id:22, section:'🚗 Court से घर — Transition', time:'5:00 PM', task:'Car में बैठते ही 5 मिनट — Court वहीं छोड़ें', tags:['🏥','🧠'], pinned:true,  skippable:false },
  { id:23, section:'🚗 Court से घर — Transition', time:'5:15 PM', task:'बगीचे में 20 मिनट — Court के stress को release', tags:['🌿','🏥'], pinned:true,  skippable:false },
  { id:24, section:'🚗 Court से घर — Transition', time:'5:35 PM', task:'चाय — शांति से, Phone नहीं (10 मिनट)', tags:['🌸'], pinned:false, skippable:true  },
  { id:25, section:'❤️ परिवार + Sanjay + Mahi', time:'6:00 PM', task:'Sanjay के साथ — बगीचे में 15 मिनट', tags:['❤️','🌿'], pinned:true,  skippable:false },
  { id:26, section:'❤️ परिवार + Sanjay + Mahi', time:'6:15 PM', task:'माही के साथ — आज क्या किया सुनें (Judge नहीं)', tags:['❤️'], pinned:false, skippable:true  },
  { id:27, section:'❤️ परिवार + Sanjay + Mahi', time:'7:00 PM', task:'Satsang / Spiritual Reading — 30 मिनट', tags:['🕉️'], pinned:false, skippable:true  },
  { id:28, section:'❤️ परिवार + Sanjay + Mahi', time:'8:00 PM', task:'Family Dinner — तीनों साथ, Phone नहीं', tags:['❤️','🏥'], pinned:true,  skippable:false },
  { id:29, section:'❤️ परिवार + Sanjay + Mahi', time:'8:00 PM', task:'दिन की 1 अच्छी बात share करें', tags:['❤️'], pinned:false, skippable:true  },
  { id:30, section:'🌙 रात — Wind Down', time:'9:00 PM', task:'Journal Writing — आज क्या सीखा, क्या दिया', tags:['🕉️','🧠'], pinned:false, skippable:true  },
  { id:31, section:'🌙 रात — Wind Down', time:'9:15 PM', task:'Sanjay के साथ Quality Time — Advocate mode बंद', tags:['❤️'], pinned:true,  skippable:false },
  { id:32, section:'🌙 रात — Wind Down', time:'9:30 PM', task:"'ॐ' — 21 बार (दीपक के सामने)", tags:['🕉️'], pinned:false, skippable:true  },
  { id:33, section:'🌙 रात — Wind Down', time:'9:45 PM', task:'Phone बंद — Screen Time खत्म', tags:['🏥'], pinned:false, skippable:true  },
  { id:34, section:'🌙 रात — Wind Down', time:'9:50 PM', task:'सोएं — अच्छी नींद = अच्छी Sudarshan Kriya', tags:['🏥'], pinned:true,  skippable:false },
]
